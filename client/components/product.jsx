...
const Product = (props) => {
  ...
  return (
    <div className="product flex flex-col items-center justify-between p-2 m-2 bg-yellow-100 border-2 rounded-lg border-lime-600">
      ...
      <p className="product__price">Price for one: {product.priceCurrency}</p>
